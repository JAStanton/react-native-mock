...
/**
   ...
   */},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(ListView,[{key:'getMetrics',value:function getMetrics()
...
}},{key:'getDefaultProps',value:function getDefaultProps()

{
return{
renderScrollComponent:function renderScrollComponent(props){return _react2.default.createElement(_ScrollView2.default,props);}};
...
{
return null;
}}]);return ListView;}(_react2.default.Component);
