...
mixins=[_ScrollResponder2.default.Mixin],_temp),_possibleConstructorReturn(_this,_ret);}_createClass(ScrollView,[{key:'setNativeProps',value:function setNativeProps(
...
}},{key:'endRefreshin',value:function endRefreshin()
...
{
return null;
}}]);return ScrollView;}(_react2.default.Component);
